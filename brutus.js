 ...
 */
   ...
   var results = "";
   var triviaQuestionList = new Array();  // Contains js objects of Questions and Answers
   var panelQuestions = new Array();      // Contains html to display each Question and Answers
   var submittedAnswers = new Array();    // Contains the Answers submitted to each question
   ...
   function playTriviaGame(){
      ...
      submittedAnswers = new Array(triviaQuestionList.length);
      $('#gameQuestionPanel').html(panelQuestions[currentQuestionIndex]);
      $('#gameQuestions').show();
   }
   ...
   $(function(){
       var i = 0;
       $('#btnLastQuestion').bind('click', function(){
          if (i < panelQuestions.length){
        	 currentQuestionIndex = i--;
             $('#gameQuestionPanel').html(panelQuestions[currentQuestionIndex]);
          }
   ...
   $(function(){
       $('#btnSubmitQuestion').bind('click', function(){
    	   submittedAnswers[currentQuestionIndex] = $("input[name='answer']:checked").val();
       });
   });
